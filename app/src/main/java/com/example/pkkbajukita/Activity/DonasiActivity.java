...
public class DonasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_cover =  findViewById(R.id.img_donasi_dns_cover);
        ...
        btn_dns.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (et_nm_brg.getText().toString().equals("") || et_ket.getText().toString().equals("") || et_lokasi.getText().toString().equals("")){
                    Toast.makeText(getApplicationContext(),"Mohon diisi semua", Toast.LENGTH_SHORT).show();
                } else {
                    //Toast.makeText(getApplicationContext(),"COCOK", Toast.LENGTH_SHORT).show();
                   // btn_dns();

                    Bitmap bmap = ((BitmapDrawable) img_cover.getDrawable()).getBitmap();
                    Drawable myDrawable = getResources().getDrawable(R.drawable.imagebutton);
                    final Bitmap myLogo = ((BitmapDrawable) myDrawable).getBitmap();

                    if (bmap.sameAs(myLogo)){
                        Toast.makeText(getApplicationContext(),"MOHON ISI IMAGE", Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(getApplicationContext(),"YAYAYA", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode== CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if (resultCode ==  RESULT_OK){
                ...
                img_cover.setImageURI(mImageUri);
                img_cover.setVisibility(View.INVISIBLE);
                img_brg.setVisibility(View.VISIBLE);

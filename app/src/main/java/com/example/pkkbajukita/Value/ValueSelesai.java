...
public class ValueSelesai {
    ...
    public ValueSelesai(String id_barang, String nama_barang, String ket_barang, String lokasi_barang, String img_barang, String no_wa) {
